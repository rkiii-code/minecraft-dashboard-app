...
import { getMetrics, getPlayer, getPlayerScores } from '../lib/api';
import type { Metric, PlayerScore } from '../lib/types';
  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      ...
      <div className="card-grid">
        <Card title="プロフィール" subtitle="ログイン履歴">
        ...
        <Card title="簡易履歴" subtitle="ラフなスパークバー">
          <div className="grid" style={{ gap: 10 }}>
            {scoreCards.map((score) =>
              score.metric ? (
